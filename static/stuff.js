...
fetch(`https://home.calschwick.net/analytics/submit?type=calvin-website&url=${encodeURIComponent(window.location)}&token=${encodeURIComponent(id)}&new=${isNew?1:0}&count=${count}`, {
